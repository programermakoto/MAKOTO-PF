      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          <div className="text-center p-3">
            ...
            <br></br>
            <Link href="https://github.com/programermakoto" className="border rounded-3xl m-2 border-solid hover:bg-gray-900 hover:text-white border-white py-2 px-4">GitHubで確認</Link>
            <Link href="https://kanoa-group.com/hp-create" className="border rounded-3xl m-2 border-solid hover:bg-gray-900 hover:text-white border-white px-4 py-2">会社HPで確認</Link>
          </div>
        ...
        <ItemLayout className={"col-span-full md:col-span-8 !p-0"}>
          <div className=" p-3 flex justify-center items-center">
            <div className="py-10">
              ...
              <Link href="https://kanoa-group.com" className="border rounded-3xl  border-solid hover:bg-gray-900 hover:text-white border-white my-10 px-4 py-2">株式会社KANOA GROUPのHPを確認</Link>
            </div>
          </div>
        ...
        <ItemLayout className={"col-span-full md:col-span-6 !p-0"}>
          ...
          >
            <div className="text-center p-3">
              ...
              <p className="text-sm">全ビジネスのスキルが動画で学べ&現役経営者や技術者に質問可能。<br></br>更にスクールがお金をお客さんに支払う仕組み=案件がスキル不要で取得可能</p>
              <hr></hr>
